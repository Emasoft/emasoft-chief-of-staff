# Memory Directory Structure - Part 2: Validation and Operations

## Table of Contents
1. [How to validate structure](#structure-validation)
2. [How to repair damaged structure](#repair-damaged-structure)
3. [For implementation examples](#examples)
   - 3.1 [Create Complete Structure from Scratch](#example-1-create-complete-structure-from-scratch)
   - 3.2 [Verify Structure Integrity](#example-2-verify-structure-integrity)
   - 3.3 [Create Snapshot with Proper Structure](#example-3-create-snapshot-with-proper-structure)
4. [If issues occur](#troubleshooting)

**Related Documents:**
- [Part 1: Overview and Naming](./02-memory-directory-structure-part1-overview.md) - Purpose, canonical structure, directory descriptions, naming conventions
...
### Example 1: Create Complete Structure from Scratch
...
### Example 2: Verify Structure Integrity
...
### Example 3: Create Snapshot with Proper Structure
...
### Problem: Pattern Category Directories Missing
...
### Problem: Cannot Determine Structure Version
...
### Problem: File Permissions Prevent Access
...
**Previous**: See [Part 1: Overview and Naming](./02-memory-directory-structure-part1-overview.md) for structure purpose, canonical layout, directory descriptions, and naming conventions.
