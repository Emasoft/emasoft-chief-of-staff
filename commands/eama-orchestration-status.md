---
name: eama-orchestration-status
...
allowed-tools: ["Bash(python3 ${CLAUDE_PLUGIN_ROOT}/scripts/eama_orchestration_status.py:*)"]
---
...
```!
python3 "${CLAUDE_PLUGIN_ROOT}/scripts/eama_orchestration_status.py" $ARGUMENTS
```
